...
<?php $__env->startSection('styles'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/webdist/vendor/libs/timepicker/timepicker.css')); ?>">
...
##parent-placeholder-16728d18790deb58b3b8c1df74f06e536b532695##
    ...
    <script src="<?php echo e(asset('/webdist/vendor/libs/timepicker/timepicker.js')); ?>"></script>
    ...
    <script>
        var apiPath = '<?php echo e(config('AppConfig.endpoint.api.Master')); ?>/shift';
        ...
        var vueListShift = new Vue({
            ...
            methods: {
                ...
                loadList(curPage,q='',orderBy=false,sortDesc=false) {
                    ...
                    window.location.href = "<?php echo e(route('master.shift.list')); ?>?" + params(this.loadParams.params);
...
<div id="vueListShift">
    <h4 class="d-flex justify-content-between align-items-center w-100 font-weight-bold py-1 mb-1">
        ...
        <?php if(\UserAuth::hasAccess('Master.shift','c')): ?>
            ...
            <table class="table table-striped table-bordered mb-0">
                ...
                <tbody>
                    <tr v-for="(item,i) in data.data">
                        ...
                        <td>           
                            <?php if(\UserAuth::hasAccess('Master.shift','u')): ?>                 
                            <a   :href="('<?php echo e(route('master.shift.detail',['id'=>'SHIFT_ID'])); ?>').replace('SHIFT_ID',item.id)" class="btn btn-success btn-xs icon-btn md-btn-flat article-tooltip" title="View Detail">
                            ...
                            <?php if(\UserAuth::hasAccess('Master.shift','d')): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout-horizontal-sidenav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arisoftindonesia/Documents/Tekmira/simpegptt/app/MainApp/Modules/Master/resources/views/shift/list.blade.php ENDPATH**/ ?>