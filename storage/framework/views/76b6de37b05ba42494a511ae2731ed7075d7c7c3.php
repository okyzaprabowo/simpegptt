...
<div id="vueLapRekapKehadiran">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="formFilterTanggal" action="<?php echo e(route('laporan.kehadiran_harian')); ?>">
                <div class="row">                
            ...
            <table class="table table-striped table-bordered mb-0 table-content">
                <thead>
                    <tr>
                        ...
                        ?>
                        <th class="<?php echo e($class); ?>"><?php echo e($tgl); ?><br><small><?php echo e($weekMap[$hari]); ?></small></th> 
                        <?php } ?>
                        ...
                        ?>
                        <th data-toggle="tooltip" class="bg-success-lighter" title="<?php echo e($kategori['kategori']['nama']); ?>"><?php echo e($kategori['kategori']['singkatan']); ?><br><small>Hari</small></th> 
                        <?php }} ?>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo e(route('laporan.jejak_kehadiran',['pegawaiId'=>$v['id']])); ?>"><?php echo e($v['nama']); ?></a></td>
                        ...
                        ?>
                        <td>
                            <?php echo e(isset($absensi[$v['id']]['jenisIjinKategori'][$kategori['kategori']['id']]) ? $absensi[$v['id']]['jenisIjinKategori'][$kategori['kategori']['id']] : 0); ?>
        ...
        <div class="card-body"> 
            ...
            <div class="row">
                <div class="col-12 pt-3">
                    <h5> <?php echo e(isset($v['kategori']['nama'])?$v['kategori']['nama']:''); ?> :</h5>
                </div>
                <?php foreach($v['jenisIjin'] as $v2 ){ ?>
                <div class="col-md-6 col-sm-12">
                    <b class="badge" style="background-color: <?php echo e($v2['warna']); ?>">  &nbsp; </b> <?php echo e($v2['nama']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout-horizontal-sidenav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arisoftindonesia/Documents/Tekmira/simpegptt/app/MainApp/Modules/Laporan/resources/views/laporan/kehadiran_harian.blade.php ENDPATH**/ ?>