    ...
    <script>
        ...
        var vueListPegawai = new Vue({
            ...
            data: {
                ...
                sortBy: "id",
                sortDesc: false,
                searchString: "<?php echo e($filter['q']); ?>",
                curPage: 1,
                perPage: <?php echo e($limit); ?>,
            ...
            methods: {
                showForm(isAdd=true,id=0) {   
                    this.isAdd = isAdd;
                    if(!isAdd){
                        window.location.href = ("<?php echo e(route('pegawai.edit',['id'=>'PEGAWAI_ID'])); ?>").replace("PEGAWAI_ID",id);
                    }else{    
                        window.location.href = ("<?php echo e(route('pegawai.view',['id'=>'PEGAWAI_ID'])); ?>").replace("PEGAWAI_ID",id);
                    }
                },
                goSearch()
                {
                ...
                loadList(curPage,q='',orderBy=false,sortDesc=false) {
                    ...
                    window.location.href = "<?php echo e(route('pegawai.list')); ?>?" + params(this.loadParams.params);
...
<div id="vueListPegawai">
    <h4 class="d-flex justify-content-between align-items-center w-100 font-weight-bold py-1 mb-4">
        ...
        <?php if(\UserAuth::hasAccess('Pegawai.master','c')): ?>
        <a href="<?php echo e(route('pegawai.addNew')); ?>" class="btn btn-primary rounded-pill d-block">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout-horizontal-sidenav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arisoftindonesia/Documents/Tekmira/simpegptt/app/MainApp/Modules/Pegawai/resources/views/pegawai/list.blade.php ENDPATH**/ ?>