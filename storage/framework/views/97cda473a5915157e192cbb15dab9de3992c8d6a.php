...
##parent-placeholder-16728d18790deb58b3b8c1df74f06e536b532695##
    ...
    <script>
        var apiPath = "<?php echo e(config('AppConfig.endpoint.api.Pegawai')); ?>";
        var vueFormPegawai = new Vue({
            ...
            data: {
                ...
                instansiList: <?php echo json_encode($instansiList); ?>,
                instansi:[],
                instansiIds: <?php echo json_encode($instansiIds); ?>,
                isEditable: true,
                isProfile: false,
                isSatker: <?php echo e($isSatker?'true':'false'); ?>,
                isPegawaiPtt: <?php echo e($isPegawaiPtt?'true':'false'); ?>,
            ...
            created: function() {
                if(this.mode=='add'){
                    ...
                    if(this.form.foto_url) this.fotoPreview = '<?php echo e(\Storage::url('/')); ?>' + this.form.foto;                    
                }        
            ...
            methods: {
                ...
                saveData(data) {  
                    var that = this;                
                    axios.post("<?php echo e(route('pegawai.api.create')); ?>", data,
                        {
                            headers: {        
                        ...
                        .then((res) => {
                            ...
                            window.location.href = "<?php echo e(route('pegawai.list')); ?>";                            
                        }).catch((err) => {
                ...
                updateData(id, data) {  
                    ...
                    axios.post(("<?php echo e(route('pegawai.api.update',['id'=>'PEGAWAI_ID'])); ?>").replace('PEGAWAI_ID',id), data,
                        {
                            headers: {        
                                'Content-Type': 'multipart/form-data'        
                            }
...
<div id="vueFormPegawai">
    <h4 class="d-flex justify-content-between align-items-center w-100 font-weight-bold py-1 mb-4">
        ...
        <div><span class="text-muted font-weight-light"><a href="<?php echo e(route('pegawai.list')); ?>">Kepegawaian</a> /</span> View Pegawai</div>
        <?php else: ?>
        <div><span class="text-muted font-weight-light"><a href="<?php echo e(route('pegawai.list')); ?>">Kepegawaian</a> /</span> Form Pegawai</div>
        <?php endif; ?>
    </h4>
                    ...
                    <table class="table table-borderless table-sm">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <?php if($mode=='profile' || $mode=='view'): ?>
                                    <?php echo e($data['jabatan']?$data['jabatan']['nama']:'-'); ?>

                                    <?php else: ?>               
                                    <select class="select2-select" onchange="vueFormPegawai.form.jabatan_id = this.value" data-allow-clear="true">
                                        <?php $__currentLoopData = $jabatan['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($val['id']); ?>" <?php echo e(isset($data['jabatan_id'])&&$val['id']==$data['jabatan_id']?' selected="true"':''); ?>><?php echo e($val['nama']); ?></option>
                            ...
                            <tr>
                                ...
                                <td>           
                                    ...
                                    <template v-for="(instansiItem, key) in instansi">
                                        <select @change="changeInstansi(key)" class="form-control mb-2" v-model="instansiIds[key+1]" <?php echo e(($mode=='profile' || $mode=='view' || $isSatker) ? ' readonly="true" disabled="true"' : ''); ?>>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($mode=='profile' || $mode=='view'): ?>
                                        <?php echo e($data['is_enable'] == 1 ? 'Aktif' : 'Non Aktif'); ?>

                                    <?php else: ?>
                                        <input type="radio" onclick="vueFormPegawai.form.is_enable = this.value" name="is_enable" value="1" <?php echo e(isset($data['is_enable'])&&1==$data['is_enable']?' checked="true"':''); ?>> Aktif &nbsp;&nbsp;
                                        <input type="radio" onclick="vueFormPegawai.form.is_enable = this.value" name="is_enable" value="0" <?php echo e(isset($data['is_enable'])&&0==$data['is_enable']?' checked="true"':''); ?>> Non Aktif
                                    <?php endif; ?>
                                </td>
                            </tr>
        ...
        <div class="nav-tabs-top">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="user-biografi">
                    <?php echo $__env->make('pegawai.formbiografi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>

                <div class="tab-pane fade" id="user-alamat">
                    <?php echo $__env->make('pegawai.formalamat',['data'=>[],'count'=>0], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>

                <div class="tab-pane fade" id="user-pendidikan">
                    <?php echo $__env->make('pegawai.formpendidikan',['data'=>[],'count'=>0], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>

                <div class="tab-pane fade" id="user-keluarga">
                    <?php echo $__env->make('pegawai.formkeluarga',['data'=>[],'count'=>0], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>

                <div class="tab-pane fade" id="user-doktah">
                    <?php echo $__env->make('pegawai.formdoktah',['data'=>[],'count'=>0], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout-horizontal-sidenav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arisoftindonesia/Documents/Tekmira/simpegptt/app/MainApp/Modules/Pegawai/resources/views/pegawai/form.blade.php ENDPATH**/ ?>