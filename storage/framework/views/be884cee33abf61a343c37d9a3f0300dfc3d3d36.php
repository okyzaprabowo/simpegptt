...
<?php $__env->startSection('styles'); ?>
    ...
    <!-- <link rel="stylesheet" href="<?php echo e(asset('/webdist/vendor/libs/bootstrap-daterangepicker/bootstrap-daterangepicker.css')); ?>"> -->
...
##parent-placeholder-16728d18790deb58b3b8c1df74f06e536b532695##
    ...
    <!-- <script src="<?php echo e(asset('/webdist/vendor/libs/bootstrap-daterangepicker/bootstrap-daterangepicker.js')); ?>"></script> -->
    ...
    <script src="<?php echo e(asset('/webdist/vendor/libs/bootbox/bootbox.js')); ?>"></script>
    ...
    <script>
        var apiPath = '<?php echo e(config('AppConfig.endpoint.api.Absensi')); ?>/permohonan/approve';
        var apiPath2 = '<?php echo e(config('AppConfig.endpoint.api.Absensi')); ?>/permohonan/approval';
        var apiJeniIjinPath = '<?php echo e(config('AppConfig.endpoint.api.Master')); ?>/jenis_ijin';
        var vueListPermohonanAbsen = new Vue({
            ...
            data: {
                ...
                data: {
                   ...
                   offset: <?php echo e($offset); ?>,
                   pageCount: <?php echo e($pageCount); ?>,
                   alasans:[]
                },
...
<div id="vueListPermohonanAbsen">
    <h4 class="d-flex justify-content-between align-items-center w-100 font-weight-bold py-1 mb-1">
        <div><span class="text-muted font-weight-light">Dashboard /</span> <?php echo e($page_title); ?></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout-horizontal-sidenav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arisoftindonesia/Documents/Tekmira/simpegptt/app/MainApp/Modules/Absensi/resources/views/permohonan_absen/listapproval.blade.php ENDPATH**/ ?>