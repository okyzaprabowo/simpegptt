...
<nav class="layout-navbar navbar navbar-expand-lg align-items-lg-center bg-white container-p-x" id="layout-navbar">
    ...
    <a href="<?php echo e(route('dashboard')); ?>" class="navbar-brand">SIPEG BPSDM</a>
            ...
            <div class="demo-navbar-user nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                    <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
                        ...
                        <span class="px-1 mr-lg-2 ml-2 ml-lg-0"><?php echo e(\UserAuth::user('name')); ?></span>
                    </span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                     
                    <a href="<?php echo e(\UserAuth::is('pegawai_ptt')?route('pegawai.profile'):route('user.profile')); ?>" class="dropdown-item">
                    ...
                    <div class="dropdown-item">
                        <i class="ion ion-md-radio-button-on text-lightest"></i> &nbsp; <b><?php echo e($value['name']); ?></b>
                    </div>
                    <?php 
                            }else{
                    ?>
                    
                    <a href="<?php echo e(route('user.changerole',['role_code'=>$key])); ?>" class="dropdown-item">
                        <i class="ion ion-md-radio-button-off text-lightest"></i> &nbsp; <?php echo e($value['name']); ?>
                    ...
                    <a href="<?php echo e(route('auth.logout')); ?>" class="dropdown-item">
                        <i class="ion ion-ios-log-out text-danger"></i> &nbsp; <?php echo e(__('auth.logout')); ?>
...
<!-- / Layout navbar -->
<?php /**PATH /Users/arisoftindonesia/Documents/Tekmira/simpegptt/app/MainApp/resources/views/layouts/includes/layout-navbar.blade.php ENDPATH**/ ?>