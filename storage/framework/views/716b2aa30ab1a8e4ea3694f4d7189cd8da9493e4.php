        ...
        <table class="table table-striped table-bordered mb-0">
            ...
            <tbody>
                <tr v-for="(item,i,k) in form.doktah">
                    <td>{{i+1}}</td>                        
                    <td>
                        <a target="_blank" :href="'<?php echo e(Storage::url('/')); ?>' + item.filepath" v-if="!(item.filepath instanceof Object)">
                            {{item.filename}}
                        </a>
                        <template v-else>
                            {{item.filename}}
...
</div><?php /**PATH /Users/arisoftindonesia/Documents/Tekmira/simpegptt/app/MainApp/Modules/Pegawai/resources/views/pegawai/formdoktah.blade.php ENDPATH**/ ?>